...
import com.libros.librosappkotlin.databinding.ActivityAgregarPdfBinding
...
class Agregar_Pdf : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.activity_agregar_pdf)
    ...
    private fun mostrarMiniatura(uri: Uri) {
        try {
            ...
            binding.previewPdf.setImageBitmap(bitmap)
            binding.previewPdf.visibility = android.view.View.VISIBLE
            ...
            e.printStackTrace()
            Toast.makeText(this, "Error al mostrar vista previa", Toast.LENGTH_SHORT).show()
        }
    }
}
